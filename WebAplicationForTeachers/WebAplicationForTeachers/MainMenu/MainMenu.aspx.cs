...
namespace WebAplicationForTeachers
{
    public partial class WebForm4 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                var FirstItem = (from i in db.YearSet
                                 ...
                                 select i).First();
                if (FirstItem == null) LabelYearHeader.Text = "Musíte vytvořit nový školní rok";
        ...
        protected void Add_Student_Click(object sender, EventArgs e)
        {
            ...
            if (FirstName.Text == "") { FirstName.BackColor = Color.MistyRose; FirstName.ToolTip = "Povinný údaj"; formFalse = true; }
            if (LastName.Text == "") { LastName.BackColor = Color.MistyRose; LastName.ToolTip = "Povinný údaj"; formFalse = true; }
            if (formFalse) return;
        ...
        {
            if (tbNewStudyCategory.Text == "") { tbNewStudyCategory.BackColor = Color.MistyRose; tbNewStudyCategory.ToolTip = "Povinný údaj"; return; }
            else
            {
        ...
        {
            if (tbNewStudySubCategory.Text == "") { tbNewStudySubCategory.BackColor = Color.MistyRose; tbNewStudySubCategory.ToolTip = "Povinný údaj"; return; }
            else
            {
